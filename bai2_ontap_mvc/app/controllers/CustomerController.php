...
class CustomerController{
    ...
    function listCustomer(){
        ...
        include_once "app/views/Customer/ListCostomer.php";
    }
...
//        print_r($_POST);
        ...
        require_once "app/views/Customer/AddCostomer.php";
    }
    ...
    public function detailCustomer()
    {
        if (isset($_GET['id'])) {
            ...
            require_once "app/views/Customer/UpdateCostomer.php";
        }
    }
    ...
    function deleteCustomerController(){
        ...
        $customer=$this->customer->getCustomer();
        require_once "app/views/Customer/ListCostomer.php";
    }
}
